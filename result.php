...
<?php
    ...
    $ip2 = $row_list_domain[$new_des];
    endwhile;

    
    ?>
    <h1> Your input </h1>
Source: <?php echo $src; ?>  IP address:(<?php echo $ip_type1 ?>  ) <br>
Destination: <?php echo $des; ?>  IP address:(<?php echo $ip_type2 ?>   )<br>
